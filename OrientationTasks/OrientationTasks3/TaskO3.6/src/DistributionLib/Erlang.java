...
/**
 * A random number generator based on the DistributionLib.Erlang distribution.
...
public class Erlang extends Generator implements ContinuousGenerator {
  private double scale, shape;
	...
	if (scale <= 0.0)
	    throw new ParameterException("DistributionLib.Erlang: The scale parameter must be greater than 0.");
	this.scale = scale;
	this.shape = shape;
    }
