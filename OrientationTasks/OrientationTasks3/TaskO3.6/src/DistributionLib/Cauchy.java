...
/**
 * A random number generator based on the DistributionLib.Cauchy distribution.
...
public class Cauchy extends Generator implements ContinuousGenerator {
	...
	if (scale <= 0.0)
	    throw new ParameterException("DistributionLib.Cauchy: The scale parameter must be greater than 0.");
	this.median = median;
	this.scale = scale;
    }
