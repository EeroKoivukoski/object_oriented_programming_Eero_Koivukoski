 ...
 * automatically generated by the <code>DistributionLib.MetaGenerator</code>
...
public class Geometric extends Generator implements DiscreteGenerator {
    ...
    private void set(double prob) {
        if (prob<=0 || prob>=1)
            throw new ParameterException("DistributionLib.Geometric: The probability of success must be between 0 and 1.");
        this.prob = prob;
    }
