...
/** A DistributionLib.SeedGenerator is a DistributionLib.DiscreteGenerator which produces well-spaced seeds
 *  according to its spacing attribute. It relies on a <code>DistributionLib.RandomGenerator</code>
 */
public class SeedGenerator implements DiscreteGenerator {
    ...
    // ----- implements DistributionLib.DiscreteGenerator { -----
    public long sample() {
